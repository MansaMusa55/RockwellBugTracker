...
namespace RockwellBugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,Created,TicketId,RecipientId,SenderId,Viewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,Created,TicketId,RecipientId,SenderId,Viewed")] Notification notification)
        {
